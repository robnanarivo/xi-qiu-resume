...
\section{Research \& Projects}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      {\positionItem{Full-Stack Web Application} \techStack{React, Express, MongoDB, Heroku}}{Sep. 2021 -- Present}
      \resumeItemListStart
        \resumeItem{Created Reddit-like social network website in team of 4 under the Scrum framework and deployed through Heroku}
        \resumeItem{Built front-end with React \& MUI and back-end with Express \& MongoDB; tested with Jest and Cypress}
        \resumeItem{Independently implemented in-APP synchronous chatting that supports images, audio, and video; built the feature through polling, file streaming with Multer, and file storage with MongoDB GridFS}
      \resumeItemListEnd
