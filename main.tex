  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Researched on integration of WasmEdge in smart cars using tools from the Erdos Project and containerization of WebAssembly applications using CRI-O}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Designed credit system for TikTok advertisers and validated system using data analysis and visualization tools (Jupyter, Pandas, Matplotlib, Seaborn); presented credit system to product, operation, and sales teams}
        \resumeItem{Conducted quantitative analysis of potential risk factors in TikTok advertising ecosystem; provided risk-control strategies and worked with product and operation teams on implementation}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Sourced 400+ start-ups through Wechat, cold calls, and automated emails sent through Python scripts; convinced 90+ start-ups to apply to MiraclePlus in Fall 2020 round}
    \resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \vspace{2pt}
     ...
     \textbf{\color{emph} Tools}{: Git, Linux, AWS Lambda, Docker, Node.js, React, Selenium} \\
